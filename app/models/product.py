...
class Product:
    ...
    def __repr__():
        return f'Product("{self.product_id}","{self.product_name}",{self.opinions},{self.opinions_count},{self.cons_count},{self.average_score})'
    
    def __str__():
        return f'({self.product_id},{self.product_name},{self.opinions},{self.opinions_count},{self.cons_count},{self.average_score})'
